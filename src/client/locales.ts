...
export const zh = {
  ...
  'drawer.resetFilters': '重置',
  'drawer.resetFiltersTitle': '重置全部过滤与排序（立即保存）',
  'drawer.loading': '加载中…',
  ...
  'doc.globalRunUnavailable': '全局节点暂不支持会话内执行或加入 run',
  ...
  'run.join': '加入 run',
  'run.joinTitle': '把该节点范围内的 Ticket/SubTicket 加入 run',
  ...
  'drawer.createScope': '请选择归属',
  'drawer.scopeWorkspace': '当前工作区',
  'drawer.scopeGlobal': '全局',
...
export const en: Record<OmtKey, string> = {
  ...
  'drawer.resetFilters': 'Reset',
  'drawer.resetFiltersTitle': 'Reset all filters and sorting (saved immediately)',
  ...
  'doc.globalRunUnavailable': 'Global nodes cannot be executed or joined to runs from a workspace session yet',
  ...
  'run.join': 'Add to run',
  'run.joinTitle': 'Add Ticket/SubTicket work in this node’s scope to a run',
  ...
  'drawer.createScope': 'Choose storage scope',
  'drawer.scopeWorkspace': 'Current workspace',
  'drawer.scopeGlobal': 'Global',
