...
为 OMT 插件增加/优化 UI 能力，让 ticket 体系的浏览、管理与引用在 DSH 界面中更直观高效。

## 范围

- 抽屉树（shell.overlay）的交互与视觉优化
- 文档详情面板（details 动态遮蔽）的展示与操作体验
- 激活 ticket 状态条、`@` 引用 chip 等界面元素
- 与 DSH 原生 UI 规范（slot 纪律、主题 token）的对齐
